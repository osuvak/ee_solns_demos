classdef stick_breaking_test < ee_solns_demos.testers.GenericTester
    ...
    methods(Access=public)
        function obj = stick_breaking_test()
            title       = 'Stick Breaking Test - on the length of the segment that holds a prepositioned scratch on a stick';
            description = ...
                { ...
