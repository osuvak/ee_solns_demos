classdef binom2pois_approx_test_mex_cpp < ee_solns_demos.testers.GenericTester
    ...
    methods(Access=public)
        function obj = binom2pois_approx_test_mex_cpp()
...
st = binom2pois_approx_mex_cpp( lam , n , noMCTests );
